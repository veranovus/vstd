...
static bool std_map_condition_usize(const usize *a, const usize *b) {
  return *(a) == *(b);
}

static bool std_map_condition_string(const String *a, const String *b) {
  return std_string_compare(a, b->ptr) == STD_STRING_EQUAL;
}

static bool std_map_condition_void(const void *a, const void *b) {
  return a == b;
}
#endif
